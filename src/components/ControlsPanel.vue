    ...
    <div class="tab-content">
      <div class="tab-pane fade show active" id="nav-legenda" role="tabpanel" aria-labelledby="nav-legenda-tab" tabindex="0">
        ...
        <div class="col-md-11 mx-auto form-floating focused-label">
          <select v-model="propertyValue" class="form-select form-select-md text-primary fw-semibold text-center shadow-sm" id="floatingSelect" @change="emitUpdate">
        ...
        <div class="row pt-2 px-3">
          ...
          <div class="col-md-6 text-center">
            <button id="playSlider" type="button" class="btn py-2 fw-medium w-100" :class="buttonClass" @click="toggleSlider">
              <i v-if="isPlaying" class="bi bi-pause-circle-fill"></i><i v-else class="bi bi-google-play"></i>{{ isPlaying ? 'Pauzeren' : 'Afspelen' }}
            </button>
          </div>
        </div>
